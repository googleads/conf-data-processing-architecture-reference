 ...
 */
public class InstantSecondsConverter implements AttributeConverter<Instant> {

  @Override
  public AttributeValue transformFrom(Instant instant) {
    return instant == null
        ? AttributeValues.nullAttributeValue()
        : AttributeValues.numberValue(instant.getEpochSecond());
  }
  ...
  public Instant transformTo(AttributeValue attributeValue) {
    return attributeValue.n() == null
        ...
        : Instant.ofEpochSecond(Long.parseLong(attributeValue.n()));
  }
