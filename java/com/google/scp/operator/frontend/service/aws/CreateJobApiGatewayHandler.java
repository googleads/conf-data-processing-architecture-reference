...
public final class CreateJobApiGatewayHandler
    extends ApiGatewayHandler<CreateJobRequestWithMetadata, CreateJobResponse> {
  ...
  @Override
  protected CreateJobRequestWithMetadata toRequest(
    ...
    try {
      ...
      CreateJobRequest createJobRequest = protoBuilder.build();
      validateProperties(createJobRequest, json);
