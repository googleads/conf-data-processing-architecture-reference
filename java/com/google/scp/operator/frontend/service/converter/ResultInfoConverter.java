 ...
 * com.google.scp.operator.protos.shared.backend.ResultInfoProto.ResultInfo} and {@link
 * com.google.scp.operator.protos.frontend.api.v1.ResultInfoProto.ResultInfo}.
 */
public final class ResultInfoConverter
  ...
  protected ResultInfo doForward(
    ...
    return ResultInfo.newBuilder()
        ...
        .putAllResultMetadata(resultInfo.getResultMetadata())
        .build();
  }

  /** Converts the frontend model into the shared model. */
  @Override
  protected com.google.scp.operator.protos.shared.backend.ResultInfoProto.ResultInfo doBackward(
      ResultInfo resultInfo) {
    return com.google.scp.operator.protos.shared.backend.ResultInfoProto.ResultInfo.newBuilder()
        .setReturnCode(resultInfo.getReturnCode())
        .setReturnMessage(resultInfo.getReturnMessage())
        .setFinishedAt(resultInfo.getFinishedAt())
