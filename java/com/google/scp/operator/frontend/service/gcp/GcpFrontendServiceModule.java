...
import static com.google.scp.operator.frontend.service.gcp.FrontendServiceHttpFunctionBase.JOB_V1;
...
public final class GcpFrontendServiceModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bind(String.class).annotatedWith(JobDbTableName.class).toInstance(jobTableName);
    bind(Integer.class).annotatedWith(MetadataDbSpannerTtlDays.class).toInstance(metadataTtlDays);
    bind(Integer.class).annotatedWith(JobDbSpannerTtlDays.class).toInstance(metadataTtlDays);
    bind(Integer.class)
