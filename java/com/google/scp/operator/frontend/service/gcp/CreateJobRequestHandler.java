...
public class CreateJobRequestHandler
    extends CloudFunctionRequestHandlerBase<CreateJobRequestWithMetadata, CreateJobResponse> {
  ...
  @Override
  protected CreateJobRequestWithMetadata toRequest(HttpRequest httpRequest)
    ...
    try {
      ...
      CreateJobRequest.Builder createJobRequestBuilder = CreateJobRequest.newBuilder();
      parser.merge(json, createJobRequestBuilder);

      // Get associated request metadata like the requesters account identity (email).
      CreateJobRequestMetadata.Builder createJobRequestMetadataBuilder =
          CreateJobRequestMetadata.newBuilder();
      Optional<String> identity = getAccountIdentityFromHttpHeader(httpRequest);
      identity.ifPresent(createJobRequestMetadataBuilder::setAccountIdentity);

      return CreateJobRequestWithMetadata.builder()
          .setCreateJobRequest(createJobRequestBuilder.build())
          .setCreateJobRequestMetadata(createJobRequestMetadataBuilder.build())
          .build();
  ...
  @Override
  protected CreateJobResponse processRequest(
      CreateJobRequestWithMetadata createJobRequestWithMetadata) throws ServiceException {
    return frontendService.createJob(createJobRequestWithMetadata);
  }
