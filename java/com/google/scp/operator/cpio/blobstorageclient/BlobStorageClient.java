...
public interface BlobStorageClient {
  ...
  class BlobStorageClientException extends Exception {
    ...
    public BlobStorageClientException(Throwable cause) {
      super(cause);
      this.reason = UNSPECIFIED_ERROR;
    }

    /** Creates a new instance from a {@code Throwable} and error reason. */
    public BlobStorageClientException(Throwable cause, ErrorReason reason) {
      super(cause);
      this.reason = reason;
    }
    ...
    /** Creates a new instance with message and error reason. */
    public BlobStorageClientException(String message, ErrorReason reason) {
      super(message);
      this.reason = reason;
    }
