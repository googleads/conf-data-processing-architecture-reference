...
public interface JobClient {
   ...
   *
   * @param getJobRequest GetJobRequest of the job to get.
   ...
   */
  Optional<Job> getJob(GetJobRequest getJobRequest) throws JobClientException;
   ...
   * @deprecated Use returnJobForRetry instead.
   */
  @Deprecated
