...
public final class HybridEncryptionKeyServiceImpl implements HybridEncryptionKeyService {
  ...
  /** Creates a new instance of the {@code HybridEncryptionKeyServiceImpl} class. */
  @Inject
  public HybridEncryptionKeyServiceImpl(
      Aead aead, PrivateKeyFetchingService privateKeyFetchingService) {
    this.aead = aead;
  ...
  public HybridEncrypt getEncrypter(String keyId) throws KeyFetchException {
    ErrorReason reason = ErrorReason.INTERNAL;
    throw new KeyFetchException("Method not supported", reason);
  }
