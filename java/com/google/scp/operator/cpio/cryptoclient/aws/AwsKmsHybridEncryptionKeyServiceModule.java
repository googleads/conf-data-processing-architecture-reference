 ...
 * from an HTTP endpoint and decrypts the private key by directly talking to AWS KMS.
 *
 * <p>This module does not perform binary attestation and therefore will only work in development
 * environments.
 */
public final class AwsKmsHybridEncryptionKeyServiceModule extends HybridEncryptionKeyServiceModule {
