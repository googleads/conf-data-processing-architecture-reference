...
import static com.google.scp.operator.cpio.cryptoclient.aws.AwsKmsHybridEncryptionKeyServiceModule.AwsKmsKeyArn;
...
/**
 * Guice module for implementation of {@link HybridEncryptionKeyService}.
 *
 * <p>This module should only be used within the context of an AWS Nitro Enclave. Outside of an
 * enclave {@link AwsKmsHybridEncryptionKeyServiceModule} should be used instead.
 */
public final class AwsEnclaveHybridEncryptionKeyServiceModule
  ...
  public Class<? extends HybridEncryptionKeyService> getHybridEncryptionKeyServiceImplementation() {
    return HybridEncryptionKeyServiceImpl.class;
  }
