...
/** Holds configuration parameters for {@code GcpKmsHybridEncryptionKeyServiceModule}. */
@AutoValue
public abstract class GcpKmsHybridEncryptionKeyServiceConfig {

  /** Returns an instance of the {@code GcpKmsHybridEncryptionKeyServiceConfig.Builder} class. */
  public static Builder builder() {
    return new AutoValue_GcpKmsHybridEncryptionKeyServiceConfig.Builder()
  ...
  public Optional<Aead> coordinatorAAead() {
    return coordinatorAEncodedKeysetHandle()
        .map(GcpKmsHybridEncryptionKeyServiceConfig::getAeadFromEncodedKeysetHandle);
  }
  ...
  /** Builder class for the {@code GcpKmsHybridEncryptionKeyServiceConfig} class. */
  @AutoValue.Builder
  public abstract static class Builder {
    ...
    /**
     * Uses the builder to construct a new instance of the {@code
     * GcpKmsHybridEncryptionKeyServiceConfig} class.
     */
    public abstract GcpKmsHybridEncryptionKeyServiceConfig build();
  }
}
