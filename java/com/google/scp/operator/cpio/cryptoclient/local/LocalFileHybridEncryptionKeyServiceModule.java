...
/**
 * Guice Module for the local file implementation of {@link HybridEncryptionKeyService} where key is
 * stored at {@link DecryptionKeyFilePath}.
 */
public final class LocalFileHybridEncryptionKeyServiceModule
  ...
  public Class<? extends HybridEncryptionKeyService> getHybridEncryptionKeyServiceImplementation() {
    return LocalFileHybridEncryptionKeyService.class;
  }

  /**
   * Annotation for a local path to the decryption key used for {@link
   * LocalFileHybridEncryptionKeyService}
   */
  @BindingAnnotation
