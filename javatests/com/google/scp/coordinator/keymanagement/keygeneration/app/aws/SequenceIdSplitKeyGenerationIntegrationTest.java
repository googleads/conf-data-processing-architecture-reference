...
/**
 * Integration tests which test the critical journeys of the SplitKeyGeneration process with
 * Sequence id
 *
...
public final class SequenceIdSplitKeyGenerationIntegrationTest
    extends SplitKeyGenerationIntegrationTestBase {
  ...
  public static class TestEnv extends AbstractModule {
    ...
    public void configure() {
      ...
      bind(new Key<Optional<String>>(KeyIdTypeName.class) {}).toInstance(Optional.of("SEQUENCE"));
