...
public final class CreateKeysPubSubListenerTest {
  ...
  @Mock private CreateKeysTask mockTask;
  ...
  public void start_success() throws ServiceException {
    ...
    PubsubMessage message =
        PubsubMessage.newBuilder().setData(ByteString.copyFromUtf8("generateKeys")).build();
    ...
    CreateKeysPubSubListener listener =
        new CreateKeysPubSubListener(
            config,
            mockTask,
            PROJECT_ID,
            SUBSCRIPTION_ID,
    ...
    verify(mockTask).replaceExpiringKeys(numberOfKeysToCreate, validityInDays, ttlInDays);
  }
}
