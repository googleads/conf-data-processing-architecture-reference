...
public final class CloudFunctionEmulatorContainer
  ...
  private static final String invokerJarFilename = "java-function-invoker-1.3.1.jar";
  ...
  /** Start a container that runs a local cloud function emulator. */
  public static CloudFunctionEmulatorContainer startContainer(
  ...
  public static CloudFunctionEmulatorContainer startContainerAndConnectToPubSub(
      PubSubEmulatorContainer pubSubEmulatorContainer,
      Optional<Map<String, String>> envVariables,
      String functionFilename,
      String functionJarPath,
