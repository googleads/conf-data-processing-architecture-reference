...
public final class LocalFrontendServiceV1HttpFunction extends FrontendServiceHttpFunctionBase {
  public LocalFrontendServiceV1HttpFunction() {
    this(
        Guice.createInjector(
            new FrontendServiceHttpFunctionTestModule(), new FrontendServiceV1Module()));
  }

  @Inject
  public LocalFrontendServiceV1HttpFunction(Injector injector) {
    super(
