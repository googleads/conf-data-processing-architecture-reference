...
public class FrontendServiceV2CloudFunctionEmulatorContainer extends AbstractModule {
  public FrontendServiceV2CloudFunctionEmulatorContainer() {}
  ...
  public CloudFunctionEmulatorContainer getFunctionContainer(
    ...
    return startContainerAndConnectToSpannerAndPubSub(
        ...
        Optional.empty(),
        "LocalFrontendServiceV2HttpCloudFunction_deploy.jar",
        "javatests/com/google/scp/operator/frontend/service/gcp/testing/v2/",
        "com.google.scp.operator.frontend.service.gcp.testing.v2.LocalFrontendServiceV2HttpFunction");
  }
}
