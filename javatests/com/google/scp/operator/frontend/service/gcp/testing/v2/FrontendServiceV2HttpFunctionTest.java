...
import com.google.scp.operator.frontend.service.gcp.FrontendServiceHttpFunction;
...
public final class FrontendServiceV2HttpFunctionTest {
  ...
  public void service_createJobApiSupported() throws Exception {
    ...
    verify(putJobRequestHandler).handleRequest(httpRequest, httpResponse);
    verify(getJobByIdRequestHandler, never()).handleRequest(httpRequest, httpResponse);
  }
  ...
  public void service_createJobTrailingCharactersFails() throws Exception {
    ...
    verify(getJobByIdRequestHandler, never()).handleRequest(httpRequest, httpResponse);
    verify(putJobRequestHandler, never()).handleRequest(httpRequest, httpResponse);
  }
  ...
  public void service_getJobApiSupported() throws Exception {
    ...
    verify(getJobByIdRequestHandler).handleRequest(httpRequest, httpResponse);
    verify(putJobRequestHandler, never()).handleRequest(httpRequest, httpResponse);
  }
