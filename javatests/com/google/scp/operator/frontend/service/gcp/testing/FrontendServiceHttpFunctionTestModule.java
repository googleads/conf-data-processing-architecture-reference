...
import com.google.scp.operator.shared.dao.metadatadb.gcp.SpannerJobDb;
...
public class FrontendServiceHttpFunctionTestModule extends AbstractModule {
  ...
  @Singleton
  @JobMetadataDbClient
  public DatabaseClient getMetadaDatabaseClient() throws ExecutionException, InterruptedException {
  ...
  @Singleton
  @JobDbClient
  public DatabaseClient getJobDatabaseClient() throws ExecutionException, InterruptedException {
    SpannerOptions options =
        SpannerOptions.newBuilder()
            .setEmulatorHost(System.getenv("SPANNER_EMULATOR_HOST"))
            .setCredentials(NoCredentials.getInstance())
  ...
  @Provides
  @JobDbSpannerTtlDays
  Integer provideJobDbSpannerTtlDays() {
    return 1;
  }

  @Provides
  @JobDbTableName
  String provideJobDbTableName() {
    return "JobTestTable";
  }
