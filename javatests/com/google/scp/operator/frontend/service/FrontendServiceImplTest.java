...
public final class FrontendServiceImplTest {
  ...
  CreateJobRequestWithMetadata createJobRequestWithMetadata;
  ...
  public void setUp() throws ParseException {
    ...
    createJobRequestWithMetadata =
        ServiceJobGenerator.createFakeCreateJobRequestWithMetadata(REQUEST_ID);
    putJobRequest =
  ...
  public void testCreateJob_simple() throws Exception {
    ...
    frontendService.createJob(createJobRequestWithMetadata);
  ...
  public void testCreateJob_validationFailure() {
    ...
    ServiceException serviceException =
        assertThrows(
            ServiceException.class, () -> frontendService.createJob(createJobRequestWithMetadata));
    ...
    ServiceException expectedServiceException =
        new ServiceException(
            ...
            String.format(
                ...
                createJobRequestWithMetadata.getCreateJobRequest().getJobRequestId()));
    assertThatServiceExceptionMatches(serviceException, expectedServiceException);
    assertThat(fakeMetadataDb.getLastJobMetadataInserted()).isNull();
  }
