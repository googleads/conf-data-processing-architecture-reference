...
public class AwsKmsHybridEncryptionKeyServiceTest {
  ...
  @Inject HybridEncryptionKeyServiceImpl awsKmsHybridEncryptionKeyService;
  ...
  public void testDecryption() throws Exception {
    ...
    HybridDecrypt hybridDecrypt =
        awsKmsHybridEncryptionKeyService.getDecrypter(UUID.randomUUID().toString());
