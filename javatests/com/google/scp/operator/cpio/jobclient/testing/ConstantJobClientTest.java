...
public class ConstantJobClientTest {
  ...
  public void pullDefaultEmpty() throws Exception {
    Optional<Job> jobPulled = jobClient.getJob(GetJobRequest.builder().build());
  ...
  public void pullConstantAndExhaust() throws Exception {
    ...
    Optional<Job> exhaustedItem = jobClient.getJob(GetJobRequest.builder().build());
  ...
  public void testGetJobThrowsWhenSetTo() throws Exception {
    ...
    assertThrows(JobClientException.class, () -> jobClient.getJob(GetJobRequest.builder().build()));
    Optional<Job> jobPulled = jobClient.getJob(GetJobRequest.builder().build());
