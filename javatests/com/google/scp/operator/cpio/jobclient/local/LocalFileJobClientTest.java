...
public class LocalFileJobClientTest {
  ...
  // Under test
  @Inject LocalFileJobClient jobClient;
  ...
  public void readsAndExhausts() throws JobClientException {
    ...
    jobClient.getJob(GetJobRequest.builder().build());
    Optional<Job> jobExhausted = jobClient.getJob(GetJobRequest.builder().build());
  ...
  public void readsAndExhausts_withJobParameters() throws JobClientException {
    ...
    Optional<Job> job = jobClient.getJob(GetJobRequest.builder().build());
    Optional<Job> jobExhausted = jobClient.getJob(GetJobRequest.builder().build());
