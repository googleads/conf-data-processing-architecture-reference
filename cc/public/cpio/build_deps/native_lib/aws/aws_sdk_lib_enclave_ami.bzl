...
def aws_sdk_lib_enclave_ami(
        *,
        ...
        ports = [],
        sdk_cmd_override = [],
        ami_name = Label("//cc/public/cpio/build_deps/native_lib/aws:aws_sdk_lib_enclave_ami_name"),
        aws_region_override = Label("//cc/public/cpio/build_deps/native_lib/aws:aws_region_override"),
        debug_mode = False):
    """
