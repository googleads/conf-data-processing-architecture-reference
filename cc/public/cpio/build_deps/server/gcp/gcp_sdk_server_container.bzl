...
def gcp_sdk_server_container(
    ...
    cmrt_sdk(
        ...
        auto_scaling_service_configs = auto_scaling_service_configs,
        ...
        image = select(
            {
                ...
                Label("//cc/public/cpio/build_deps/shared:non_reproducible_build_config"): ":%s_container.tar" % cmrt_sdk_name,
            },
