 ...
 * actually usin it, and call BlobStorageClientInterface::Stop when finished
 * using it.
 */
class BlobStorageClientInterface : public core::ServiceInterface {
 public:
  ...
  /**
   * @brief Gets a Blob from storage in a blocking call.
   *
   * @param request request to get blob.
   * @return ExecutionResultOr<GetBlobResponse> result of the operation.
   */
  virtual core::ExecutionResultOr<
      google::cmrt::sdk::blob_storage_service::v1::GetBlobResponse>
  GetBlobSync(google::cmrt::sdk::blob_storage_service::v1::GetBlobRequest
                  request) noexcept = 0;
   ...
   */
  virtual void ListBlobsMetadata(
      core::AsyncContext<
  ...
  /**
   * @brief Lists Blobs metadata in storage in a blocking call.
   *
   * @param request request to list blobs metadata.
   * @return ExecutionResultOr<GetBlobResponse> result of the operation.
   */
  virtual core::ExecutionResultOr<
  ...
  /**
   * @brief Puts (inserts or updates) a Blob in storage in a blocking call.
   *
   * @param request request to put blob.
   * @return ExecutionResultOr<GetBlobResponse> result of the operation.
   */
  virtual core::ExecutionResultOr<
      google::cmrt::sdk::blob_storage_service::v1::PutBlobResponse>
  PutBlobSync(google::cmrt::sdk::blob_storage_service::v1::PutBlobRequest
                  request) noexcept = 0;
  ...
  /**
   * @brief Deletes a Blob in storage in a blocking call.
   *
   * @param request request to delete blob.
   * @return ExecutionResultOr<GetBlobResponse> result of the operation.
   */
  virtual core::ExecutionResultOr<
      google::cmrt::sdk::blob_storage_service::v1::DeleteBlobResponse>
  DeleteBlobSync(google::cmrt::sdk::blob_storage_service::v1::DeleteBlobRequest
                     request) noexcept = 0;
  ...
  /**
   * @brief Gets a Blob from storage in a blocking call using streaming manner.
   *
   * @param request request to get blob.
   * @return ExecutionResultOr<istream> result of the operation.
   */
  virtual core::ExecutionResultOr<std::unique_ptr<std::istream>>
  GetBlobStreamSync(
      const google::cmrt::sdk::blob_storage_service::v1::BlobIdentity&
          blob_identity) noexcept = 0;
  ...
  /**
   * @brief Puts (inserts or updates) a Blob to storage in a blocking call using
   * streaming manner.
   *
   * @param request request to put blob.
   * @return ExecutionResultOr<ostream> result of the operation.
   */
  virtual core::ExecutionResultOr<std::unique_ptr<std::ostream>>
  PutBlobStreamSync(
      const google::cmrt::sdk::blob_storage_service::v1::BlobIdentity&
          blob_identity) noexcept = 0;
};
