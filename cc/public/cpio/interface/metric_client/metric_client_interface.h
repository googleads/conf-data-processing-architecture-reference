...
class MetricClientInterface : public core::ServiceInterface {
 public:
  ...
  /**
   * @brief Records custom metrics on Cloud in a blocking call.
   *
   * @param request the request to put metrics.
   * @return core::ExecutionResultOr<PutMetricsResponse> the
