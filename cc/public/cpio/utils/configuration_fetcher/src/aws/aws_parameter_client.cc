...
#include "aws_parameter_client.h"
...
ExecutionResult AwsParameterClient::CreateParameterClientProvider() noexcept {
  parameter_client_provider_ = make_shared<AwsParameterClientProvider>(
      options_, instance_client_provider_, io_async_executor_);
