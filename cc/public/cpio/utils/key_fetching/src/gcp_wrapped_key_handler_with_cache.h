...
class GcpWrappedKeyHandlerWithCache
    : public WrappedKeyHandlerWithCacheBase<
          google::cmrt::sdk::v1::GcpWrappedKey> {
 public:
  explicit GcpWrappedKeyHandlerWithCache(
 ...
 protected:
  ...
  CreateDecryptRequest(const google::cmrt::sdk::v1::GcpWrappedKey&
