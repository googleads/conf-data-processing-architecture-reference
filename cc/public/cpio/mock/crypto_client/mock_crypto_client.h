...
class MockCryptoClient : public CryptoClientInterface {
 public:
  ...
  MOCK_METHOD(core::ExecutionResultOr<
              ...
              HpkeEncryptSync,
              ((const cmrt::sdk::crypto_service::v1::HpkeEncryptRequest&)),
              (noexcept, override));

  MOCK_METHOD(core::ExecutionResultOr<
                  cmrt::sdk::crypto_service::v1::HpkeDecryptResponse>,
              HpkeDecryptSync,
              ((const cmrt::sdk::crypto_service::v1::HpkeDecryptRequest&)),
              (noexcept, override));
