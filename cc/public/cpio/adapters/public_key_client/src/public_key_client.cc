...
void PublicKeyClient::ListPublicKeys(
    AsyncContext<ListPublicKeysRequest, ListPublicKeysResponse>&
        context) noexcept {
  public_key_client_provider_->ListPublicKeys(context);
}

ExecutionResultOr<ListPublicKeysResponse> PublicKeyClient::ListPublicKeysSync(
    ListPublicKeysRequest request) noexcept {
