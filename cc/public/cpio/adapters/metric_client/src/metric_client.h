...
class MetricClient : public MetricClientInterface {
 public:
  ...
  void PutMetrics(core::AsyncContext<
                  google::cmrt::sdk::metric_service::v1::PutMetricsRequest,
                  google::cmrt::sdk::metric_service::v1::PutMetricsResponse>&
                      context) noexcept override;

  core::ExecutionResultOr<cmrt::sdk::metric_service::v1::PutMetricsResponse>
  PutMetricsSync(cmrt::sdk::metric_service::v1::PutMetricsRequest
