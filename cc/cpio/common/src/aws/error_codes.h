...
MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_INVALID_REQUEST, SC_CPIO_INVALID_ARGUMENT)
MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_REQUEST_LIMIT_REACHED,
                         SC_CPIO_REQUEST_LIMIT_REACHED)
MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_SERVICE_UNAVAILABLE,
                         SC_CPIO_SERVICE_UNAVAILABLE)
MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_VALIDATION_FAILED, SC_CPIO_INVALID_ARGUMENT)
MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_NOT_FOUND, SC_CPIO_ENTITY_NOT_FOUND)
}  // namespace google::scp::core::errors
