...
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_NOT_FOUND, SC_CPIO_ENTITY_NOT_FOUND)
...
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_UNAUTHENTICATED,
                         SC_CPIO_INVALID_CREDENTIALS)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_CANCELLED, SC_CPIO_REQUEST_ABORTED)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_ALREADY_EXISTS, SC_CPIO_INVALID_ARGUMENT)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_OUT_OF_RANGE, SC_CPIO_INVALID_ARGUMENT)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_UNIMPLEMENTED, SC_CPIO_NOT_IMPLEMENTED)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_UNAVAILABLE, SC_CPIO_SERVICE_UNAVAILABLE)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_UNKNOWN, SC_CPIO_INTERNAL_ERROR)
...
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_FAILED_PRECONDITION,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_ABORTED, SC_CPIO_REQUEST_ABORTED)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_DATA_LOSS, SC_CPIO_INTERNAL_ERROR)
