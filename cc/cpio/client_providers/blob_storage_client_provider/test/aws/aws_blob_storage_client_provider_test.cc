...
class AwsBlobStorageClientProviderTest : public ScpTestBase {
 protected:
...
TEST_F(AwsBlobStorageClientProviderTest, GetBlobFailure) {
  ...
  provider_.GetBlob(get_blob_context_);
...
TEST_F(AwsBlobStorageClientProviderTest, ListBlobsWithPrefix) {
  ...
  provider_.ListBlobsMetadata(list_blobs_metadata_context_);
}
...
TEST_F(AwsBlobStorageClientProviderTest, PutBlobFailure) {
  ...
  provider_.PutBlob(put_blob_context_);
...
TEST_F(AwsBlobStorageClientProviderTest, DeleteBlobFailure) {
  ...
  provider_.DeleteBlob(delete_blob_context_);
