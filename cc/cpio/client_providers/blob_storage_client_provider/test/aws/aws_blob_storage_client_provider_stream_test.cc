...
class AwsBlobStorageClientProviderStreamTest : public ScpTestBase {
 protected:
...
TEST_F(AwsBlobStorageClientProviderStreamTest, PutBlobStream) {
  ...
  provider_.PutBlobStream(put_blob_stream_context_);
...
TEST_F(AwsBlobStorageClientProviderStreamTest, GetBlobStream) {
  ...
  *expected_response.mutable_blob_portion()->mutable_data() = bytes_str;
  ...
  provider_.GetBlobStream(get_blob_stream_context_);
...
TEST_F(AwsBlobStorageClientProviderStreamTest, GetBlobStreamNoBucketName) {
  get_blob_stream_context_.request->mutable_blob_metadata()->set_blob_name(
      kBlobName);
...
TEST_F(AwsBlobStorageClientProviderStreamTest, GetBlobStreamNoBlobName) {
  get_blob_stream_context_.request->mutable_blob_metadata()->set_bucket_name(
      kBucketName);
...
TEST_F(AwsBlobStorageClientProviderStreamTest, GetBlobStreamInvalidByteRange) {
  get_blob_stream_context_.request->mutable_blob_metadata()->set_bucket_name(
      kBucketName);
  get_blob_stream_context_.request->mutable_blob_metadata()->set_blob_name(
      kBlobName);
...
TEST_F(AwsBlobStorageClientProviderStreamTest, PutBlobStreamNoBucketName) {
  put_blob_stream_context_.request->mutable_blob_portion()
      ->mutable_metadata()
      ->set_blob_name(kBlobName);
...
TEST_F(AwsBlobStorageClientProviderStreamTest, PutBlobStreamNoBlobName) {
  put_blob_stream_context_.request->mutable_blob_portion()
      ->mutable_metadata()
      ->set_bucket_name(kBucketName);
