...
DEFINE_ERROR_CODE(
    ...
    SC_BLOB_STORAGE_PROVIDER, 0x0009,
    "Invalid cahced client lifetime in blob stroage client options.",
    HttpStatusCode::INTERNAL_SERVER_ERROR)

DEFINE_ERROR_CODE(SC_BLOB_STORAGE_PROVIDER_ERROR_INVALID_GET_BLOB_STREAM,
                  SC_BLOB_STORAGE_PROVIDER, 0x000A,
                  "Stream retrived from cloud storage is invalid.",
                  HttpStatusCode::INTERNAL_SERVER_ERROR)
DEFINE_ERROR_CODE(SC_BLOB_STORAGE_PROVIDER_ERROR_INVALID_PUT_BLOB_STREAM,
                  SC_BLOB_STORAGE_PROVIDER, 0x000B,
...
MAP_TO_PUBLIC_ERROR_CODE(
    SC_BLOB_STORAGE_PROVIDER_INVALID_CACHED_CLIENT_LIFETIME,
    SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_BLOB_STORAGE_PROVIDER_ERROR_INVALID_PUT_BLOB_STREAM,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_BLOB_STORAGE_PROVIDER_ERROR_INVALID_GET_BLOB_STREAM,
                         SC_CPIO_INTERNAL_ERROR)
}  // namespace google::scp::core::errors
