...
using google::scp::cpio::client_providers::AwsAutoScalingClientFactory;
...
constexpr char kInstanceId[] = "i-0e9801d129EXAMPLE";
...
class MockAwsAutoScalingClientFactory : public AwsAutoScalingClientFactory {
 public:
  MOCK_METHOD(
...
class AwsAutoScalingClientProviderTest : public ScpTestBase {
 protected:
  ...
  AwsAutoScalingClientProviderTest() {
    ...
    mock_auto_scaling_client_factory_ =
        make_shared<NiceMock<MockAwsAutoScalingClientFactory>>();
  ...
  shared_ptr<MockAwsAutoScalingClientFactory> mock_auto_scaling_client_factory_;
...
TEST_F(AwsAutoScalingClientProviderTest, DescribeAutoScalingInstancesFailed) {
  ...
  EXPECT_CALL(
      *mock_auto_scaling_client_,
      DescribeAutoScalingInstancesAsync(InstanceIdMatches(kInstanceId), _, _))
  ...
  EXPECT_CALL(*mock_auto_scaling_client_,
              CompleteLifecycleActionAsync(
                  CompleteLifecycleActionRequestMatches(
                      kInstanceId, kAutoScalingGroupName,
