...
class AwsAutoScalingClientFactory;
...
class AwsAutoScalingClientProvider : public AutoScalingClientProviderInterface {
 public:
  ...
  AwsAutoScalingClientProvider(
      ...
      const std::shared_ptr<AwsAutoScalingClientFactory>&
          auto_scaling_client_factory =
              std::make_shared<AwsAutoScalingClientFactory>())
 ...
 private:
   ...
   *
   * @param context the get auto_scaling operation context.
   * @param instance_id extracted instance ID from resource name.
  ...
  /// AwsAutoScalingClientFactory.
  std::shared_ptr<AwsAutoScalingClientFactory> auto_scaling_client_factory_;
  /// AutoScalingClient.
