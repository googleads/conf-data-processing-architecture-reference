...
DEFINE_ERROR_CODE(SC_PRIVATE_KEY_CLIENT_PROVIDER_INVALID_JSON,
                  SC_PRIVATE_KEY_FETCHER_PROVIDER, 0x000D, "Invalid Json",
                  HttpStatusCode::INTERNAL_SERVER_ERROR)
DEFINE_ERROR_CODE(
    SC_PRIVATE_KEY_CLIENT_PROVIDER_INVALID_PUBLIC_KEYSET_HANDLE_JSON,
    SC_PRIVATE_KEY_FETCHER_PROVIDER, 0x000E,
    "Invalid public keyset handle Json", HttpStatusCode::INTERNAL_SERVER_ERROR)

MAP_TO_PUBLIC_ERROR_CODE(SC_PRIVATE_KEY_CLIENT_PROVIDER_INVALID_JSON,
