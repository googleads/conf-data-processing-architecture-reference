...
DEFINE_ERROR_CODE(SC_AWS_QUEUE_CLIENT_PROVIDER_MESSAGE_NOT_IN_FLIGHT,
                  ...
                  HttpStatusCode::BAD_REQUEST)
DEFINE_ERROR_CODE(SC_AWS_QUEUE_CLIENT_PROVIDER_INVALID_MESSAGE_BODY,
                  SC_AWS_QUEUE_CLIENT_PROVIDER, 0x0008,
                  "The message receiving from SQS is missing message body",
                  HttpStatusCode::INTERNAL_SERVER_ERROR)
DEFINE_ERROR_CODE(SC_AWS_QUEUE_CLIENT_PROVIDER_NO_MESSAGE_RETURNED,
                  SC_AWS_QUEUE_CLIENT_PROVIDER, 0x0009,
                  "No messages are being received from SQS",
...
MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_QUEUE_CLIENT_PROVIDER_MESSAGE_NOT_IN_FLIGHT,
                         SC_CPIO_INVALID_ARGUMENT)
MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_QUEUE_CLIENT_PROVIDER_INVALID_MESSAGE_BODY,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_QUEUE_CLIENT_PROVIDER_NO_MESSAGE_RETURNED,
