...
DEFINE_ERROR_CODE(
    ...
    "The number of messages receiving from PubSub exceed maximum number",
    HttpStatusCode::INTERNAL_SERVER_ERROR)
DEFINE_ERROR_CODE(SC_GCP_QUEUE_CLIENT_PROVIDER_INVALID_MESSAGE_BODY,
                  SC_GCP_QUEUE_CLIENT_PROVIDER, 0x000A,
                  "The message receiving from PubSub is missing message body",
                  HttpStatusCode::INTERNAL_SERVER_ERROR)
DEFINE_ERROR_CODE(SC_GCP_QUEUE_CLIENT_PROVIDER_NO_MESSAGE_RETURNED,
                  SC_GCP_QUEUE_CLIENT_PROVIDER, 0x000B,
                  "No messages are being received from PubSub",
...
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_QUEUE_CLIENT_PROVIDER_MESSAGES_NUMBER_EXCEEDED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_QUEUE_CLIENT_PROVIDER_INVALID_MESSAGE_BODY,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_QUEUE_CLIENT_PROVIDER_NO_MESSAGE_RETURNED,
