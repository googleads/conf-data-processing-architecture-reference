...
class GcpNoSQLDatabaseClientProvider
 ...
 public:
   ...
   * @param gcp_database_factory Factory which provides the Spanner Client.
   */
 ...
 private:
  ...
  struct CreateItemOptions {
    ...
    // The ttl of the item
    google::cloud::spanner::Timestamp ttl;
  ...
  /**
   * @brief Extracts the acquired JSON value and ttl from row_stream, then
   * merges it with the json in read_modify_write_options and writes it into
   * spanner_json.
   *
   ...
   * @param spanner_json
   * @param ttl ttl of the database item.
   * @return ExecutionResult
   */
  core::ExecutionResult GetMergedData(
      core::AsyncContext<
          cmrt::sdk::nosql_database_service::v1::UpsertDatabaseItemRequest,
          cmrt::sdk::nosql_database_service::v1::UpsertDatabaseItemResponse>&
      ...
      std::optional<google::cloud::spanner::Timestamp>& ttl);
  ...
  google::cloud::spanner::Mutations UpsertFunctor(
      ...
      const nlohmann::json& new_attributes,
