 ...
 public:
  ...
  ConvertJsonTypeToItemAttribute(const nlohmann::json& json_value) {
    ...
    if (json_value.is_number_integer()) {
      ...
      attribute.set_value_json_string(nlohmann::to_string(json_value));
    } else {
  ...
  static core::ExecutionResultOr<nlohmann::json> ConvertItemAttributeToJsonType(
    ...
    switch (attribute.value_case()) {
      ...
      case cmrt::sdk::nosql_database_service::v1::ItemAttribute::
          kValueJsonString:
        if (ValidateJsonString(attribute)) {
          return nlohmann::ordered_json::parse(attribute.value_json_string());
        }
        return core::FailureExecutionResult(
            core::errors::SC_NO_SQL_DATABASE_PROVIDER_INVALID_JSON_STRING);
      case cmrt::sdk::nosql_database_service::v1::ItemAttribute::VALUE_NOT_SET:
      default:
        return core::FailureExecutionResult(
            core::errors::SC_NO_SQL_DATABASE_PROVIDER_INVALID_PARAMETER_TYPE);
  ...
  ConvertItemAttributeToSpannerValue(
    ...
    switch (attribute.value_case()) {
      ...
      case cmrt::sdk::nosql_database_service::v1::ItemAttribute::
          kValueJsonString:
        if (ValidateJsonString(attribute)) {
          return google::cloud::spanner::Value(
              google::cloud::spanner::Json(attribute.value_json_string()));
        }
        return core::FailureExecutionResult(
            core::errors::SC_NO_SQL_DATABASE_PROVIDER_INVALID_JSON_STRING);
      case cmrt::sdk::nosql_database_service::v1::ItemAttribute::VALUE_NOT_SET:
  ...
  bool static ValidateJsonString(
      const cmrt::sdk::nosql_database_service::v1::ItemAttribute& attribute) {
    return nlohmann::json::accept(attribute.value_json_string());
  }
};
}  // namespace google::scp::cpio::client_providers
