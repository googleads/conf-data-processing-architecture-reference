...
DEFINE_ERROR_CODE(
    ...
    SC_NO_SQL_DATABASE_PROVIDER, 0x000D,
    "NoSQL Datasbase client failed to init due to invalid nosql database "
    "options",
    HttpStatusCode::BAD_REQUEST)

DEFINE_ERROR_CODE(SC_NO_SQL_DATABASE_PROVIDER_INVALID_JSON_STRING,
                  SC_NO_SQL_DATABASE_PROVIDER, 0x000E, "Invalid JSON string.",
                  HttpStatusCode::BAD_REQUEST)
...
MAP_TO_PUBLIC_ERROR_CODE(SC_NO_SQL_DATABASE_PROVIDER_CONDITIONAL_CHECKED_FAILED,
                         SC_CPIO_INVALID_ARGUMENT)
MAP_TO_PUBLIC_ERROR_CODE(SC_NO_SQL_DATABASE_PROVIDER_CLIENT_OPTIONS_REQUIRED,
                         SC_CPIO_INVALID_ARGUMENT)
MAP_TO_PUBLIC_ERROR_CODE(SC_NO_SQL_DATABASE_PROVIDER_INVALID_JSON_STRING,
                         SC_CPIO_INVALID_ARGUMENT)
}  // namespace google::scp::core::errors
