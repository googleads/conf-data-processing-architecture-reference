...
DEFINE_ERROR_CODE(SC_AWS_ROLE_CREDENTIALS_PROVIDER_INVALID_REQUEST,
                  SC_AWS_ROLE_CREDENTIALS_PROVIDER, 0x0003,
                  "The request is invalid.", HttpStatusCode::BAD_REQUEST)

MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_ROLE_CREDENTIALS_PROVIDER_INITIALIZATION_FAILED,
                         SC_CPIO_COMPONENT_FAILED_INITIALIZED)
MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_ROLE_CREDENTIALS_PROVIDER_INVALID_REQUEST,
