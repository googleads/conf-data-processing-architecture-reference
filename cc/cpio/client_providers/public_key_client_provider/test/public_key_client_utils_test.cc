...
static constexpr char kCacheControlExample1[] = "max-age=254838,public";
static constexpr char kCacheControlExample2[] = "public,max-age=254838";
static constexpr char kCacheControlExample3[] = "public, max-age=254838";
static constexpr char kCacheControlExample4[] =
    "max-age=254838, must-understand";
static constexpr char kCacheControlExample5[] =
    "public, max-age=254838, must-understand";
static constexpr char kCacheControlMissingMaxAge[] = "public,must-understand";
static constexpr char kHeaderDateExampleBadStr[] = "2011-February-18 23:12:34";
static constexpr char kCacheControlExample1BadInt[] = "max-age=b2t54838abs";
static constexpr uint64_t kExpectedExpiredTimeSecs = 1668811806;

namespace google::scp::cpio::client_providers::test {
TEST(PublicKeyClientUtilsTest, ParseExpiredTimeFromHeadersSuccess1) {
  HttpHeaders headers;
  headers.insert({kPublicKeyHeaderDate, kHeaderDateExample});
  headers.insert({kPublicKeyHeaderCacheControl, kCacheControlExample1});
...
TEST(PublicKeyClientUtilsTest, ParseExpiredTimeFromHeadersSuccess2) {
  HttpHeaders headers;
  headers.insert({kPublicKeyHeaderDate, kHeaderDateExample});
  headers.insert({kPublicKeyHeaderCacheControl, kCacheControlExample2});
...
TEST(PublicKeyClientUtilsTest, ParseExpiredTimeFromHeadersSuccess3) {
  HttpHeaders headers;
  headers.insert({kPublicKeyHeaderDate, kHeaderDateExample});
  headers.insert({kPublicKeyHeaderCacheControl, kCacheControlExample3});
...
TEST(PublicKeyClientUtilsTest, ParseExpiredTimeFromHeadersSuccess4) {
  HttpHeaders headers;
  headers.insert({kPublicKeyHeaderDate, kHeaderDateExample});
  headers.insert({kPublicKeyHeaderCacheControl, kCacheControlExample4});
...
TEST(PublicKeyClientUtilsTest, ParseExpiredTimeFromHeadersSuccess5) {
  HttpHeaders headers;
  headers.insert({kPublicKeyHeaderDate, kHeaderDateExample});
  headers.insert({kPublicKeyHeaderCacheControl, kCacheControlExample5});
...
TEST(PublicKeyClientUtilsTest, ParseExpiredTimeMissingMaxAge) {
  HttpHeaders headers;
  headers.insert({kPublicKeyHeaderDate, kHeaderDateExample});
  headers.insert({kPublicKeyHeaderCacheControl, kCacheControlMissingMaxAge});
...
TEST(PublicKeyClientUtilsTest, HeadersWithBadCacheControlStr) {
  HttpHeaders headers;
  headers.insert({kPublicKeyHeaderDate, kHeaderDateExample});
  headers.insert({kPublicKeyHeaderCacheControl, kCacheControlExample1BadInt});
