...
ExecutionResult GcpParameterClientProvider::Init() noexcept {
  ...
  sm_client_shared_ = secret_manager_factory_->CreateClient(options_);
...
shared_ptr<SecretManagerServiceClient> SecretManagerFactory::CreateClient(
...
void GcpParameterClientProvider::GetParameter(
