...
void TestInstanceClientProvider::GetCurrentInstanceResourceName(
    AsyncContext<GetCurrentInstanceResourceNameRequest,
                 GetCurrentInstanceResourceNameResponse>& context) noexcept {
  string resource_name;
  GetCurrentInstanceResourceNameSync(resource_name);
  context.result = SuccessExecutionResult();
  context.response = make_shared<GetCurrentInstanceResourceNameResponse>();
  context.response->set_instance_resource_name(resource_name);
  context.Finish();
}

void TestInstanceClientProvider::GetTagsByResourceName(
...
void TestInstanceClientProvider::GetInstanceDetailsByResourceName(
