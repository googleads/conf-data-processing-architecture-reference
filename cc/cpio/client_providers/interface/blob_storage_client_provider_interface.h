...
class BlobStorageClientProviderInterface : public core::ServiceInterface {
 public:
  ...
  GetBlobStreamSync(const cmrt::sdk::blob_storage_service::v1::BlobIdentity&
   ...
   * @return ExecutionResultOr<PutBlobResponse> result of the operation.
   */
  virtual core::ExecutionResultOr<std::unique_ptr<std::ostream>>
  PutBlobStreamSync(const cmrt::sdk::blob_storage_service::v1::BlobIdentity&
                        blob_identity) noexcept = 0;
};
