...
#include "public/cpio/proto/parameter_service/v1/configuration_keys.pb.h"

using google::cmrt::sdk::parameter_service::v1::ClientConfigurationKeys;
using google::cmrt::sdk::parameter_service::v1::ClientConfigurationKeys_Name;
...
ParameterServiceFactory::CreateInstanceServiceFactoryOptions() noexcept {
  ...
  instance_service_factory_options
      ...
      ClientConfigurationKeys_Name(
          ClientConfigurationKeys::CMRT_PARAMETER_CLIENT_CPU_THREAD_COUNT);
  instance_service_factory_options->cpu_async_executor_queue_cap_config_label =
      ClientConfigurationKeys_Name(
          ClientConfigurationKeys::
              CMRT_PARAMETER_CLIENT_CPU_THREAD_POOL_QUEUE_CAP);
  instance_service_factory_options
      ->io_async_executor_thread_count_config_label =
      ClientConfigurationKeys_Name(
          ClientConfigurationKeys::CMRT_PARAMETER_CLIENT_IO_THREAD_COUNT);
  instance_service_factory_options
      ->io_async_executor_queue_cap_config_label = ClientConfigurationKeys_Name(
      ClientConfigurationKeys::CMRT_PARAMETER_CLIENT_IO_THREAD_POOL_QUEUE_CAP);
