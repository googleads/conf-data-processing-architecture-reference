 ...
 */
class MetricServiceFactory : public MetricServiceFactoryInterface {
 public:
  explicit MetricServiceFactory(
 ...
 protected:
  ...
  virtual std::shared_ptr<MetricClientOptions>
  CreateMetricClientOptions() noexcept;
