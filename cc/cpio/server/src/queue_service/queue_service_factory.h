...
#include "cpio/server/interface/queue_service/queue_service_factory_interface.h"

namespace google::scp::cpio {
/*! @copydoc QueueServiceFactoryInterface
 */
class QueueServiceFactory : public QueueServiceFactoryInterface {
 public:
  explicit QueueServiceFactory(
 ...
 protected:
  ...
  virtual std::shared_ptr<QueueClientOptions>
