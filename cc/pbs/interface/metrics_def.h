 ...
 *               Events: kMetricEventUnloadToDBScheduled
 *               Events: kMetricEventUnloadToDBSuccess
 *               Events: kMetricEventUnloadToDBFailed
 */
...
static constexpr char kMetricEventUnloadToDBScheduled[] =
    "UnloadToDB Scheduled";
static constexpr char kMetricEventUnloadToDBSuccess[] = "UnloadToDB Success";
static constexpr char kMetricEventUnloadToDBFailed[] = "UnloadToDB Failed";
