...
static constexpr char kPBSWorkloadGeneratorMaxHttpRetryCount[] =
    "google_scp_pbs_workload_generator_max_http_retry_count";
static constexpr char kPBSWorkloadGeneratorHttp2ConnectionReadTimeoutInSec[] =
    "google_scp_pbs_workload_generator_http2_connection_read_timeout_sec";

// Use separate IO priorities for background and non-background activities to
// ensure stability under high workloads.
static constexpr char kPBSPerformIOPrioritization[] =
    "google_scp_pbs_perform_io_prioritization";

static constexpr char kMaxOutstandingBudgetUnloadToDBOperationsCount[] =
    "google_scp_pbs_max_outstanding_budget_unload_to_db_op_count";
