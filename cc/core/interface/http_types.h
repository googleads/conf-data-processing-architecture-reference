...
struct HttpRequest {
  ...
  // Only implemented for HTTP1 client. If present, indicates that the
  // connection should be established over a UNIX socket rather than a TCP
  // socket. The value is the path to the UNIX socket.
  std::shared_ptr<Uri> unix_socket_path;
