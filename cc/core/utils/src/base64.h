 ...
 * @return ExecutionResultOr<string> decoded string.
 */
ExecutionResultOr<std::string> Base64Decode(const std::string& encoded);

/**
 * @brief Encodes values to base64.
 *
 * @param decoded The input value to be encoded.
 * @return ExecutionResultOr<string> The output value.
 */
