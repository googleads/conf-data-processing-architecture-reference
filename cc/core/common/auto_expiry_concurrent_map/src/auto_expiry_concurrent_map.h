...
class AutoExpiryConcurrentMap : public ServiceInterface {
 public:
   ...
   * moment. Please use the real one for unit tests.
   * TODO: Make AutoExpiryConcurrentMap able to work with MockAsyncExecutor.
   */
   ...
   * value into the map otherwise, out_key will point to the existing key in the
