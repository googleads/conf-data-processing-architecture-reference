...
source "amazon-ebs" "amzn2023-ami" {
...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      # Install and enable Docker. Pinned to version 24.0.5-1.amzn2023.0.3 due to incompatibility with version 25.
      # TODO: Upgrade to version 25 once it is compatible due to https://alas.aws.amazon.com/AL2023/ALAS-2024-542.html
